...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            <a href="<?= base_url('administrativos/matriculas/solicitudes') ?>" class="btn btn-secondary mb-3">
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <?php if ($esImagen): ?>
                        <!-- Mostrar imagen -->
                        <img src="<?= base_url('administrativos/matriculas/comprobante/' . $solicitud['id']) ?>" 
                             alt="Comprobante" 
                             class="img-fluid rounded border"
                             style="max-height: 600px;">
                    <?php else: ?>
                        <!-- Mostrar PDF en iframe -->
                        <iframe src="<?= base_url('administrativos/matriculas/comprobante/' . $solicitud['id']) ?>" 
                                width="100%" 
                                height="700px" 
                    ...
                    <div class="mt-3">
                        <a href="<?= base_url('administrativos/matriculas/comprobante/' . $solicitud['id']) ?>" 
                           target="_blank" 
            ...
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form method="POST" action="<?= base_url('administrativos/matriculas/actualizar/' . $solicitud['id']) ?>">
