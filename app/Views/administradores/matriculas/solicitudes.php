                                        ...
                                        <tr data-estado="<?= esc($sol['estado']) ?>">
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    <!-- Ver Detalle -->
                                                    <a href="<?= base_url('administradores/matriculas/ver/' . $sol['id']) ?>" 
                                                       class="btn btn-info" 
                                                       title="Ver Detalle">
                                                    ...
                                                    <!-- Ver Comprobante -->
                                                    <a href="<?= base_url('administradores/matriculas/comprobante/' . $sol['id']) ?>" 
...
<script>
    ...
    function setearSolicitud(id, nombre) {
        ...
        document.getElementById('formAprobar').action = '<?= base_url('administradores/matriculas/aprobar/') ?>' + id;
        document.getElementById('formRechazar').action = '<?= base_url('administradores/matriculas/rechazar/') ?>' + id;
    }
